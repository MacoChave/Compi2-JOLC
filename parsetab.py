...
_lr_productions = [
  ...
  ('init -> instrucciones','init',1,'p_init','gramatica.py',148),
  ('instrucciones -> instrucciones instruccion','instrucciones',2,'p_instrucciones_lista','gramatica.py',152),
  ('instrucciones -> instruccion','instrucciones',1,'p_instrucciones','gramatica.py',157),
  ('instruccion -> print','instruccion',1,'p_instruccion','gramatica.py',161),
  ('instruccion -> println','instruccion',1,'p_instruccion','gramatica.py',162),
  ('instruccion -> definicion','instruccion',1,'p_instruccion','gramatica.py',163),
  ('instruccion -> asignacion','instruccion',1,'p_instruccion','gramatica.py',164),
  ('instruccion -> while','instruccion',1,'p_instruccion','gramatica.py',165),
  ('instruccion -> if','instruccion',1,'p_instruccion','gramatica.py',166),
  ('instruccion -> if_else','instruccion',1,'p_instruccion','gramatica.py',167),
  ('print -> PRINT LPAR exp_logica RPAR','print',4,'p_print','gramatica.py',171),
  ('println -> PRINTLN LPAR exp_logica RPAR','println',4,'p_println','gramatica.py',175),
  ('definicion -> ID','definicion',1,'p_definicion','gramatica.py',179),
  ('asignacion -> ID EQUAL exp_logica','asignacion',3,'p_asignacion','gramatica.py',183),
  ('while -> WHILE LPAR exp_logica RPAR LBRACE instrucciones RBRACE','while',7,'p_while','gramatica.py',187),
  ('if -> IF LPAR exp_logica RPAR LBRACE instrucciones RBRACE','if',7,'p_if','gramatica.py',191),
  ('if_else -> IF LPAR exp_logica RPAR LBRACE instrucciones RBRACE ELSE LBRACE instrucciones RBRACE','if_else',11,'p_if_else','gramatica.py',195),
  ('exp_logica -> exp_logica AND exp_logica','exp_logica',3,'p_logica_binaria','gramatica.py',199),
  ('exp_logica -> exp_logica OR exp_logica','exp_logica',3,'p_logica_binaria','gramatica.py',200),
  ('exp_logica -> NOT exp_logica','exp_logica',2,'p_logica_not','gramatica.py',205),
  ('exp_logica -> exp_relacional','exp_logica',1,'p_logica_to_relacional','gramatica.py',209),
  ('exp_relacional -> exp_relacional LESS exp_relacional','exp_relacional',3,'p_relacional_binaria','gramatica.py',213),
  ('exp_relacional -> exp_relacional LESSEQ exp_relacional','exp_relacional',3,'p_relacional_binaria','gramatica.py',214),
  ('exp_relacional -> exp_relacional GREATHER exp_relacional','exp_relacional',3,'p_relacional_binaria','gramatica.py',215),
  ('exp_relacional -> exp_relacional GREATHEREQ exp_relacional','exp_relacional',3,'p_relacional_binaria','gramatica.py',216),
  ('exp_relacional -> exp_relacional EQUALITY exp_relacional','exp_relacional',3,'p_relacional_binaria','gramatica.py',217),
  ('exp_relacional -> exp_relacional DIFERENT exp_relacional','exp_relacional',3,'p_relacional_binaria','gramatica.py',218),
  ('exp_relacional -> exp_aritmetica','exp_relacional',1,'p_relacinal_to_aritmetica','gramatica.py',227),
  ('exp_aritmetica -> exp_aritmetica PLUS exp_aritmetica','exp_aritmetica',3,'p_aritmetica_binaria','gramatica.py',231),
  ('exp_aritmetica -> exp_aritmetica MINUS exp_aritmetica','exp_aritmetica',3,'p_aritmetica_binaria','gramatica.py',232),
  ('exp_aritmetica -> exp_aritmetica TIMES exp_aritmetica','exp_aritmetica',3,'p_aritmetica_binaria','gramatica.py',233),
  ('exp_aritmetica -> exp_aritmetica DIV exp_aritmetica','exp_aritmetica',3,'p_aritmetica_binaria','gramatica.py',234),
  ('exp_aritmetica -> exp_aritmetica POT exp_aritmetica','exp_aritmetica',3,'p_aritmetica_binaria','gramatica.py',235),
  ('exp_aritmetica -> MINUS exp_aritmetica','exp_aritmetica',2,'p_aritmetica_negativo','gramatica.py',243),
  ('exp_aritmetica -> LPAR exp_logica RPAR','exp_aritmetica',3,'p_aritmetica_agrupacion','gramatica.py',247),
  ('exp_aritmetica -> NUMBER','exp_aritmetica',1,'p_aritmetica_basico_num','gramatica.py',251),
  ('exp_aritmetica -> DECIMAL','exp_aritmetica',1,'p_aritmetica_basico_dec','gramatica.py',255),
  ('exp_aritmetica -> CHAR','exp_aritmetica',1,'p_aritmetica_basico_char','gramatica.py',259),
  ('exp_aritmetica -> STRING','exp_aritmetica',1,'p_aritmetica_basico_str','gramatica.py',263),
  ('exp_aritmetica -> TRUE','exp_aritmetica',1,'p_aritmetica_basico_true','gramatica.py',267),
  ('exp_aritmetica -> FALSE','exp_aritmetica',1,'p_aritmetica_basico_false','gramatica.py',271),
  ('exp_aritmetica -> ID','exp_aritmetica',1,'p_aritmetica_basico_id','gramatica.py',275),
]
